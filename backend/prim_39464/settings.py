"""
Django settings for prim_39464 project.
...
WSGI_APPLICATION = 'prim_39464.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prim_39464 API",
    "DESCRIPTION": "API documentation for prim_39464 App",
    "VERSION": "v1",
}
